...
class PARNet(IPNet):
    ...
    def execute_multimodal_timeline(self, start_time, game_duration=901, mode_duration=150):
        ...
        total_duration = game_duration + 335  # 335s = 90s arrival + 120s settle + 15s buffer for scalability
...
if __name__ == '__main__':
    ...
    try:
        ...
        def multimodal_thread():
            ...
            # In a scalability test case (200s + 120s)
            #time.sleep(210)
            time.sleep(320)
        ...
        total_experiment_duration = 1235  # Scalability experiment duration
