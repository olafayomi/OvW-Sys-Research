...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f'Average variance in RTT observed for Tp2 link is {tp2_delay_delta_avg}ms')
        print(f'Average variance in RTT observed for Tp3 link is {tp3_delay_delta_avg}ms')
