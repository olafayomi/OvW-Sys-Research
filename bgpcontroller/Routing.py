...
class BGPDefaultRouting(Routing):
    ...
    def apply(self, all_routes):
        ...
        # 2023-05-26 use the preference value supplied to sort all routes for each prefix
        all_routes = {key: sorted(value, key=lambda x: x[1], reverse=True) for key, value in all_routes.items()}
